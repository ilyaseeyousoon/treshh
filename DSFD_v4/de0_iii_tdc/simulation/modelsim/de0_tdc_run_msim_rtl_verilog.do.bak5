...
vlog -sv -work work +incdir+C:/altera/15.0/projects/de0_iii_tdc {C:/altera/15.0/projects/de0_iii_tdc/tdc_tb.sv}

vsim -t 1ps -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L cycloneiii_ver -L rtl_work -L work -voptargs="+acc"  tdc_tb
